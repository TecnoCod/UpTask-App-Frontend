...
const ModalFormularioTarea = () => {
	...
	const { handleModalTarea, modalFormularioTarea, submitTarea, tarea } =
		useProyectos();
							...
							<div className='sm:flex sm:items-start'>
								<div className='mt-3 text-center sm:mt-0 sm:text-left w-full'>
									...
									<form className='my-10' onSubmit={handleSubmit}>
										...
										<input
											type='submit'
											className=' transition-colors bg-cyan-600 hover:bg-cyan-800 text-white w-full font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer'
